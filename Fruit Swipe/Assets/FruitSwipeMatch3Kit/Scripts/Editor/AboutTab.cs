...
namespace FruitSwipeMatch3Kit
{
	...
	public class AboutTab : EditorTab
	{
        ...
        private const string CopyrightText =
            "Fruit Swipe Match 3 Kit is brought to you by gamevanilla. Copyright (C) gamevanilla 2019-2023.";
        ...
        private const string AssetStoreUrl = "https://assetstore.unity.com/packages/templates/systems/fruit-swipe-match-3-kit-140660";
